...
class LPIPS(nn.Module):
    ...
    def forward(self, in0, in1, weight=None, retPerLayer=False, normalize=False):
        ...
        for kk in range(self.L):
            ...
            if weight is not None:
                # downsampling for weight
                weight_kk = upsample(weight, out_HW=feats0[kk].shape[2:])
                diffs[kk] = diffs[kk] *  (1 / (2*(weight_kk.repeat(1,diffs[kk].shape[1],1,1)+1e-9)))
