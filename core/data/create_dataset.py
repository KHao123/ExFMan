...
def create_dataset(data_type='train'):
    ...
    args['use_blur'] = True if ('blur_mse' in cfg.train.lossweights or 'blur_mse_uncert' in cfg.train.lossweights or 'blur_alpha_mse' in cfg.train.lossweights) else False
